...
if(isset($_POST['submit'])){
    ...
    $stmt = $conn->prepare("INSERT INTO `product`(`name`, `price`, `description`, `picture`) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $name, $price, $description, $picture);
   ...
   <a href="logout.php" class="nav-link">
    ...
    <div class="container mt-4">
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <textarea class="form-control" placeholder="Leave a description here" name="description" id="message" style="height: 200px"></textarea>
            </div><br>
            <div class="form-group">
...
<td>
  <a href="edits.php?ID=<?php echo $row['id']; ?>" class="btn btn-primary" style="width: 77px;">Edit</a>
</td>
